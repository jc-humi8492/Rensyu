...
HRESULT Sprite::Draw(SpriteData* data)
{
	...
	//移動行列
	D3DXMATRIX matTrans;
	D3DXMatrixTranslation(&matTrans, data->pos.x + center.x*data->scale.x,
	...
	center.y += data->pos.y;
	//描画
	pSprite->Draw(pTexture, &cut, &center, &postion, D3DCOLOR_ARGB(data->color.a, data->color.r, data->color.g, data->color.b));
	pSprite->End();
